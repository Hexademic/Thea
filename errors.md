...
**Seventeen instances of the shape below; two instrument errors (13, 23); one — row 24, the worst — where the instrument was never run at all; and row 25, where the *reference file* was not opened. The last three are different shapes and are described where they are filed.** Seven on 2026-08-03; #8 and
